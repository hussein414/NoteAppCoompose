...
import com.example.noteappcoompose.ui.viewmodel.NoteViewModel
import com.example.noteappcoompose.util.Screen
import com.example.noteappcoompose.util.component.NoteItem
import com.example.noteappcoompose.util.component.OrderSection
        ...
        Column(
            ...
            LazyColumn(modifier = Modifier.fillMaxSize()) {
                items(state.notes) { note ->
                    NoteItem(noteModel = note, modifier = Modifier
                        .fillMaxWidth()
                        .clickable {
                            navController.navigate(Screen.AddEditeNoteScreen.route + "?noteId={${note.id}}&noteColor=${note.color}")
                        }, onDeleteClick = {
